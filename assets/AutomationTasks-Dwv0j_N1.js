import{r as l,j as e}from"./index-V6pXZagA.js";import{P as r,C as s}from"./CodeBlock-ClK0BBrp.js";import{I as n}from"./InfoBox-D5QG7ZYC.js";const o=[{key:"packages",label:"Packages & Repos",icon:"📦",color:"#34d399"},{key:"services",label:"Services",icon:"⚙",color:"#818cf8"},{key:"firewall",label:"Firewall",icon:"🛡",color:"#fb7185"},{key:"filesystem",label:"Filesystems",icon:"💾",color:"#38bdf8"},{key:"storage",label:"Storage (LVM)",icon:"🗄",color:"#f97316"},{key:"files",label:"File Content",icon:"📄",color:"#fbbf24"},{key:"archive",label:"Archiving",icon:"🗜",color:"#a78bfa"},{key:"cron",label:"Scheduling",icon:"🕐",color:"#34d399"},{key:"security",label:"Security",icon:"🔐",color:"#fb7185"},{key:"users",label:"Users & Groups",icon:"👥",color:"#38bdf8"}];function d(){const[t,i]=l.useState("packages");return e.jsxs("div",{className:"page-container fade-in",children:[e.jsx(r,{title:"Automate RHCSA Tasks",icon:"⚡",description:"Complete, working Ansible playbooks for every RHCSA task category — packages, services, firewall, storage, users, SELinux, and more.",tags:["dnf","service","firewalld","LVM","user","SELinux","cron","template"]}),e.jsxs("p",{children:["The RHCE exam requires you to automate standard system administration tasks using Ansible. This section provides ",e.jsx("strong",{children:"complete, production-ready playbooks"})," for every RHCSA task category you're expected to automate."]}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(160px, 1fr))",gap:"10px",margin:"1.5rem 0"},children:o.map(a=>e.jsxs("button",{onClick:()=>i(a.key),style:{padding:"14px 12px",borderRadius:"var(--radius-lg)",border:`1px solid ${t===a.key?a.color:"var(--border-subtle)"}`,background:t===a.key?`${a.color}15`:"var(--bg-card)",color:t===a.key?a.color:"var(--text-muted)",cursor:"pointer",transition:"all 150ms",display:"flex",flexDirection:"column",alignItems:"center",gap:"6px",boxShadow:t===a.key?`0 0 16px ${a.color}33`:"none"},children:[e.jsx("span",{style:{fontSize:"1.4rem"},children:a.icon}),e.jsx("span",{style:{fontSize:"0.78rem",fontWeight:600,textAlign:"center"},children:a.label})]},a.key))}),t==="packages"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"Software Packages & Repositories"}),e.jsx(s,{language:"yaml",filename:"playbooks/packages.yml",code:`---
- name: Manage software packages and repositories
  ...
  tasks:
    ...
    - name: Check if a specific package is installed
      ...
      when: "'httpd' in ansible_facts.packages"`}),e.jsxs(n,{type:"exam",children:["The exam frequently asks you to install packages and ensure a repo is configured. Remember: ",e.jsx("code",{children:"state: present"})," = install, ",e.jsx("code",{children:"state: absent"})," = remove,",e.jsx("code",{children:" state: latest"})," = update to newest version."]})]}),t==="services"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"Services"}),e.jsx(s,{language:"yaml",filename:"playbooks/services.yml",code:`---
  ...
  handlers:
    ...
    - name: Start myapp
      ansible.builtin.service:
        name: myapp
        state: started
        enabled: true`})]}),t==="firewall"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"Firewall Rules"}),e.jsxs("p",{children:["Use the ",e.jsx("code",{children:"ansible.posix.firewalld"})," module to manage ",e.jsx("code",{children:"firewalld"}),"zones, services, and port rules. Key parameters: ",e.jsx("code",{children:"permanent: true"})," persists after reboot; ",e.jsx("code",{children:"immediate: true"})," applies right now."]}),e.jsxs(n,{type:"key",children:["Always use ",e.jsx("strong",{children:"both"})," ",e.jsx("code",{children:"permanent: true"})," AND",e.jsx("code",{children:" immediate: true"})," together — otherwise the rule is either only runtime (lost on reboot) or only permanent (requires firewalld restart to take effect)."]}),e.jsx(s,{language:"yaml",filename:"playbooks/firewall.yml",code:`---
- name: Configure firewall rules
  ...
  tasks:
    ...
    - ansible.builtin.debug:
        var: fw_rules.stdout_lines`})]}),t==="filesystem"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"File Systems & Mounts"}),e.jsx(s,{language:"yaml",filename:"playbooks/filesystems.yml",code:`---
- name: Manage filesystems and mounts
  ...
  tasks:
    ...
    - name: Unmount and remove from fstab
      ansible.posix.mount:
        path: /data
        state: absent`}),e.jsxs(n,{type:"tip",children:["The ",e.jsx("code",{children:"ansible.posix.mount"})," module directly manages ",e.jsx("code",{children:"/etc/fstab"}),". With ",e.jsx("code",{children:"state: mounted"}),", it both mounts the filesystem ",e.jsx("em",{children:"and"})," adds the fstab entry — you don't need a separate task for each."]})]}),t==="storage"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"Storage Devices & LVM"}),e.jsx("p",{children:"Automate the complete LVM workflow: partition disks, create physical volumes, build volume groups, create logical volumes, format them, and mount them — all in a single playbook."}),e.jsxs("div",{style:{background:"var(--bg-card)",border:"1px solid #f97316",borderRadius:"var(--radius-lg)",padding:"1.5rem",margin:"1rem 0"},children:[e.jsx("h3",{style:{color:"#f97316",marginBottom:"1rem",fontSize:"0.9rem"},children:"LVM Concept Hierarchy"}),e.jsxs("div",{style:{fontFamily:"var(--font-mono)",fontSize:"0.82rem",lineHeight:"2"},children:[e.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("span",{style:{color:"#38bdf8"},children:"/dev/sdb, /dev/sdc"}),e.jsx("span",{style:{color:"#4b5563"},children:"→"}),e.jsx("span",{style:{color:"#34d399"},children:"pvcreate"}),e.jsx("span",{style:{color:"#4b5563"},children:"→"}),e.jsx("span",{style:{color:"#818cf8",fontWeight:700},children:"Physical Volumes (PVs)"})]}),e.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("span",{style:{color:"#818cf8"},children:"PV1 + PV2"}),e.jsx("span",{style:{color:"#4b5563"},children:"→"}),e.jsx("span",{style:{color:"#34d399"},children:"vgcreate"}),e.jsx("span",{style:{color:"#4b5563"},children:"→"}),e.jsx("span",{style:{color:"#fbbf24",fontWeight:700},children:'Volume Group (VG): "datavg"'})]}),e.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("span",{style:{color:"#fbbf24"},children:"datavg"}),e.jsx("span",{style:{color:"#4b5563"},children:"→"}),e.jsx("span",{style:{color:"#34d399"},children:"lvcreate"}),e.jsx("span",{style:{color:"#4b5563"},children:"→"}),e.jsx("span",{style:{color:"#fb7185",fontWeight:700},children:"Logical Volumes: datalv, loglv"})]}),e.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("span",{style:{color:"#fb7185"},children:"/dev/datavg/datalv"}),e.jsx("span",{style:{color:"#4b5563"},children:"→"}),e.jsx("span",{style:{color:"#34d399"},children:"mkfs.xfs"}),e.jsx("span",{style:{color:"#4b5563"},children:"→"}),e.jsx("span",{style:{color:"#c084fc",fontWeight:700},children:"Mounted at /data"})]})]})]}),e.jsx(s,{language:"yaml",filename:"playbooks/lvm-full-workflow.yml",code:`---
  ...
  tasks:
    ...
    - name: Remove volume group
      community.general.lvg:
        vg: datavg
        state: absent
        force: true`})]}),t==="files"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"File Content Management"}),e.jsx(s,{language:"yaml",filename:"playbooks/file-content.yml",code:`---
  ...
  tasks:
    ...
    - name: Pull a log file back to control node
      ansible.builtin.fetch:
        ...
        flat: true    # don't create hostname subdirectory`})]}),t==="archive"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"Archiving & Compression"}),e.jsx(s,{language:"yaml",filename:"playbooks/archiving.yml",code:`---
- name: Archive and extract files
  ...
  tasks:
    ...
    - ansible.builtin.debug:
        var: archive_list.stdout_lines`})]}),t==="cron"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"Task Scheduling"}),e.jsx(s,{language:"yaml",filename:"playbooks/scheduling.yml",code:`---
  ...
  handlers:
    - name: Reload systemd and enable timer
      ansible.builtin.systemd:
        ...
        state: started
        enabled: true
        daemon_reload: true`})]}),t==="security"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"Security — SELinux & ACLs"}),e.jsx(s,{language:"yaml",filename:"playbooks/security.yml",code:`---
- name: Configure SELinux and access controls
  ...
  handlers:
    - name: Restore SELinux context
      ...
      changed_when: false`})]}),t==="users"&&e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"section-title",children:"Users & Groups"}),e.jsx(s,{language:"yaml",filename:"playbooks/users-groups.yml",code:`---
    ...
    - name: Set account expiration date
      ansible.builtin.user:
        ...
        expires: 1735689600      # Unix timestamp for 2025-01-01
                                 # Use: date -d "2025-01-01" +%s`}),e.jsxs(n,{type:"warning",children:[e.jsxs("strong",{children:["Critical: ",e.jsx("code",{children:"append: true"})," vs default"]}),"When using the ",e.jsx("code",{children:"user"})," module with ",e.jsx("code",{children:"groups:"}),", the default behavior (",e.jsx("code",{children:"append: false"}),") ",e.jsx("em",{children:"replaces"})," all supplementary groups! Always use ",e.jsx("code",{children:"append: true"})," when you only want to ADD to groups."]})]})]})}export{d as default};
